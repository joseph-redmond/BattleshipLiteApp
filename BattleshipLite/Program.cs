    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    Console.Write("Press any key to continue to the next turn");
                    Console.ReadKey();
        ...
        private static void WelcomeMessage()
        {
            ...
            Console.WriteLine("Created by Joe Redmond");
            Console.WriteLine();
        }
        ...
        private static void PlaceShips(PlayerInfoModel model)
        {
            do
            {
                Console.Write($"{model.UsersName} - Where do you want to place your ship number { model.ShipLocations.Count + 1 }: ");
